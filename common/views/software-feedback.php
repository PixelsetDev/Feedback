            ...
            <form action="" method="POST" class="text-center">
                ...
                <div id="Report" class="hidden">
                    ...
                    <div class="grid grid-cols-2 gap-x-8 w-1/2 mx-auto mb-8">
                        ...
                        <select name="BugServerOS" id="BugServerOS" class="px-2 py-1 border border-neutral-500 rounded-md w-full">
                            <option disabled selected>Please select one</option>
                            <option value="LINUX">Linux</option>
                            <option value="WINDOWS">Windows</option>
                            <option value="MACOS">MacOS</option>
                            <option value="UNIX">Unix</option>
                            <option value="OTHER">Other (Please specify in OS Version text box)</option>
                        </select>
